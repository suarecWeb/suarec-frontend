...
async function testEmailVerification() {
  ...
  try {
    ...
    const sendResponse = await axios.post(`${API_BASE_URL}/email-verification/send`, {
      userId: 1,
  ...
  try {
    ...
    const verifyResponse = await axios.post(`${API_BASE_URL}/email-verification/verify`, {
      token: 'test-token'
    });
  ...
  try {
    ...
    const resendResponse = await axios.post(`${API_BASE_URL}/email-verification/resend`, {
      email: 'test@example.com'
    });
