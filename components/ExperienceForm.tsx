...
export default function ExperienceForm({ userId, experience, onSuccess, onCancel }: ExperienceFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const experienceData = {
        ...
        endDate: formData.currentPosition ? undefined : formData.endDate ? new Date(formData.endDate) : undefined,
      };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="space-y-2">
        <label className="text-sm font-medium text-gray-700">Título del puesto</label>
