              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-4">
                  <p className="text-gray-600 mb-4">
                    {isAccepting ? (
                      <>
                        ¿Estás seguro de que deseas <strong>aceptar</strong> la
                        aplicación de <strong>{candidateName}</strong> para la
                        publicación{" "}
                        <strong>&quot;{publicationTitle}&quot;</strong>?
                      </>
                    ) : (
                      <>
                        ¿Estás seguro de que deseas <strong>rechazar</strong> la
                        aplicación de <strong>{candidateName}</strong> para la
                        publicación{" "}
                        <strong>&quot;{publicationTitle}&quot;</strong>?
                      </>
                  ...
                  <div className="mb-6">
                    ...
                    >
                      Mensaje opcional{" "}
                      {isAccepting ? "de bienvenida" : "de retroalimentación"}:
                    </label>
                    <textarea
                      id="message"
                      rows={4}
