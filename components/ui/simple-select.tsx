...
export const SimpleSelect = ({ value, onValueChange, placeholder, className, children }: SimpleSelectProps) => {
...
export const SimpleSelectItem = React.forwardRef<HTMLDivElement, SimpleSelectItemProps & { onSelect?: (value: string) => void }>(
