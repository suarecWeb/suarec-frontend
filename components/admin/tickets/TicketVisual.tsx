  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Valor pagado */}
        <div
          className={`absolute left-[6%] bottom-[calc(7%-1px)] text-center w-[40%] px-1.5 py-2 ${printOffset ? "translate-x-8" : ""}`}
        >
        ...
        {/* Fecha de compra */}
        <div
          className={`absolute right-[6%] bottom-[calc(7%-1px)] text-center w-[40%] px-1.5 py-2 ${printOffset ? "translate-x-8" : ""}`}
        >
          <p className="text-[10px] uppercase tracking-wide text-gray-800 font-extrabold leading-tight">
            Fecha de compra
          </p>
